...
os.makedirs(train_mask_root, exist_ok=True)
os.makedirs(val_img_root, exist_ok=True)
os.makedirs(val_mask_root, exist_ok=True)
...
for patient in tqdm(patients):
    ...
    p_i = patient[7:]
    if int(p_i) > 20:
        output_img_dir = val_img_root
        output_mask_dir = val_mask_root
    else:
        output_img_dir = train_img_root
        output_mask_dir = train_mask_root
